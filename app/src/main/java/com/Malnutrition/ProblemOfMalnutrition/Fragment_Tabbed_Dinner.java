...
public class Fragment_Tabbed_Dinner extends Fragment
{
    ...
    {
        View root = inflater.inflate(R.layout.fragment_tabbed_dinner, container, false);

        listView = root.findViewById(R.id.listview_history_Dinner);
        day_data=root.findViewById(R.id.day_edit_Dinner);
        ...
        reference.child("Daily_orders").child(user.getUid()).child(String.valueOf(this_day_of_year_str)).child("Dinner").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
